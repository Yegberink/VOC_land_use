...
#%%
placenames_banda = pd.read_excel("Data/placenames_sri.xlsx", sheet_name="alloetkoer_corle", header=None) #placenames in banda
...
for i in range(len(banda_documents_clean)):
    ...
    k = i + 44144 #Add a number to make it possible to pause and continue
